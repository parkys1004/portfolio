...
export const AI_CONTENTS: ContentItem[] = [
  ...
  },
  {
    id: '2',
    category: '이커머스',
    title: 'Mono Life - 미니멀 라이프스타일 샵',
    description: '미니멀리즘을 지향하는 인테리어 소품 쇼핑몰입니다. 제품의 디테일이 돋보이도록 여백을 최대한 활용하고, 모던한 타이포그래피를 적용했습니다.',
    tags: ['#Shopping', '#Minimal', '#Interior'],
    posterUrl: 'https://images.unsplash.com/photo-1618220179428-22790b461013?auto=format&fit=crop&w=800&q=80',
    backdropUrl: 'https://images.unsplash.com/photo-1618220179428-22790b461013?auto=format&fit=crop&w=1200&h=900&q=80',
    url: DEMO_URL,
    provider: 'disney',
    matchScore: 85,
    year: 2023,
